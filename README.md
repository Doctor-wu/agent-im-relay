...
- `apps/agent-inbox/dist/index.mjs` — bundled launcher entry and npm `bin` target
- `apps/agent-inbox/dist/agent-inbox` — optional SEA executable generated from the bundled launcher
